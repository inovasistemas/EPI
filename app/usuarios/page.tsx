...
const Operator: FC = () => {
  ...
  useEffect(() => {
    ...
    fetchUsers()
  }, [fetchedUsers, orderBy, permissionGroup, searchParams])
  ...
  return (
    <div
      ...
      <div
        className="flex flex-col items-start gap-3 bg-[--backgroundPrimary] sm:rounded-2xl w-full h-full overflow-auto scroll-smooth">
