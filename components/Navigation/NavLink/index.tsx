...
export function NavLink({ name, icon, href }: NavLinkProps) {
  ...
  return (
    <Link
      ...
      className='group flex items-center gap-1 data-[active=true]:bg-[--backgroundPrimary] hover:bg-[--backgroundPrimary] mt-1.5 py-1 data-[active=false]:py-2 data-[active=true]:py-2 rounded-lg font-normal active:scale-95 transition-all duration-300'
    >
