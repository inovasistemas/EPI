    ...
    <div className='group relative flex items-center bg-[--backgroundSecondary] border-box rounded-xl outline outline-transparent focus-within:outline-[--primaryColor] focus-within:outline-2 h-full transition-all duration-300'>
      <div className='relative flex items-center w-full h-full'>
        <textarea
          id={name}
          name={name}
          className='peer block bg-transparent px-[12px] pt-[23px] pb-[7px] rounded focus:outline-none w-full h-full font-normal text-[--textSecondary] text-base appearance-none resize-none'
          placeholder=' '
          value={value}
          onChange={onChange}
        />
