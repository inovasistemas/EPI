...
export function ListItem({ data }: ListItemProps) {
  return (
    <div className='gap-3 grid grid-cols-7 sm:grid-cols-12 hover:bg-zinc-50 p-3 w-full text-sm hover:underline hover:underline-offset-2 transition-all duration-150 cursor-pointer'>
